winkstart.module('auth', 'myaccount',
    ...
    /* Define the functions for this module */
    {
        ...
        // This function select and "push" the whapps "buttons" if the whapp 
        // is currently activate for the user.
        selectApp: function() {
            var THIS = this;
        ...
        // Activation function for a whapp
        ...
        // Deactivation function for a whapp
        ...
        saveBillingForm: function(form_data) {
            ...
            // Deleting the credit card number field if there is a *.
            // Means that the credit card number wasn't modified'
            ...
            winkstart.postJSON('billing.post', rest_data, function(data, status) {
                
                // Adding the inputs containing the values in order to allow the user to update
                // if he do not reload the page since those values are originally generated by the jQuery templates
                //  
                // Credit_card
                var credit_card_id = data.data.credit_cards[0].id;
                $('.myaccount_popup #credit_id_container').html('<input type="hidden" id="update_existing" name="credit_card.update_existing" value="'+credit_card_id+'" />');
                
                // Billing address
                $('.myaccount_popup #billing_address_existing').html('<input type="hidden" name="credit_card.billing_address.update_existing" id="update_existing" value="true" />');
