winkstart.module('indesign', 'popup_login', 
    /* Start module resource definitions */
    {
        ...
        templates: {
            index: 'tmpl/popup_login.html'        // This is utilized later as THIS.templates.index.tmpl({ data_here})
        },

        /* What events do we listen for, in the browser? */
        subscribe: {
            'popup_login.activate' : 'activate'
        },
