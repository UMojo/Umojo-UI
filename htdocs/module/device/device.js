winkstart.module('device', {
		...
		resources: {
			"device.list": {url: CROSSBAR_REST_API_ENDPOINT + '/accounts/{account_id}/devices', dataType: 'json', httpMethod: 'GET'},
			"device.get": {url: CROSSBAR_REST_API_ENDPOINT + '/accounts/{account_id}/devices/{device_id}', dataType: 'json', httpMethod: 'GET'},
			"device.create": {url: CROSSBAR_REST_API_ENDPOINT + '/accounts/{account_id}/devices', dataType: 'json', httpMethod: 'POST'},        
			"device.update": {url: CROSSBAR_REST_API_ENDPOINT + '/accounts/{account_id}/devices/{device_id}', dataType: 'json', httpMethod: 'POST'}
		}
	},
	function(args) {
	...
	{	
		viewDevice: function(device_data){
			$('#device-view').empty();
			var THIS = this;
			winkstart.getJSON('device.get', {crossbar: true, account_id: MASTER_ACCOUNT_ID, device_id: device_data.id}, function (json, xhr) {				
		...
		editDevice: function(device_id){
			$('#device-view').empty();
			var THIS = this;
			winkstart.getJSON('device.get', {crossbar: true, account_id: MASTER_ACCOUNT_ID, device_id: device_id}, function (json, xhr) {				
